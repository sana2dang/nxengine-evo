...
enum GameModes
{
  ...
  GP_MODS, // pausemode: Options (use game.pause())
...
#define FLAG_DROP_POWERUPS_DONTUSE                                                                                     \
  0x0400 // not used here because it doesn't seem to be set on some npc.tbl entries which DO in fact spawn powerups; see
         // the nxflag which replaces it
